...
/***/ function(module, exports, __webpack_require__) {
	...
	var infoIconPNG = __webpack_require__(179);
	var winnersIconPNG = __webpack_require__(180);

	var bob = __webpack_require__(181);
	var docCookies = __webpack_require__(182);
	__webpack_require__(183);

	var OdometerComponent = __webpack_require__(184);
	var connectedSound = new Audio(__webpack_require__(185));
	...
	var GameArea = React.createClass({
		...
		isNoneSelected: function isNoneSelected() {
			return this.state.selected.every(function (selection) {
				return !selection;
			});
		},

		getNumOff: function getNumOff() {
	...
	var HeaderBoard = React.createClass({
		...
		toggleWinners: function toggleWinners() {
			//this.changeWinners();
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					"span",
					{ id: "infoIcon", className: "icon tooltip-bottom icon", "data-tooltip": "Info" },
					React.createElement("img", { src: infoIconPNG, onClick: this.props.toggleInfo, className: this.props.displayingInfo ? 'faded' : '' })
				),
				React.createElement(
					"span",
					{ id: "winnersIcon", className: "icon tooltip-bottom", "data-tooltip": "Winner" },
					React.createElement("img", { src: winnersIconPNG, className: this.props.displayingWinners ? 'faded' : '', onClick: this.toggleWinners })
				),
	...
	var ContactRequest = React.createClass({
		...
		showPaypal: function showPaypal() {
			this.setState({
		...
		render: function render() {
			...
			if (this.state.showCash) {
				optionalCash = React.createElement(
					"div",
					null,
					"Contact Email:",
					React.createElement("br", null),
					React.createElement("input", { type: "text", ref: "contactEmail" }),
					React.createElement("br", null),
					"Address:",
					React.createElement("br", null),
			...
			if (this.state.showPaypal) {
				optionalPaypal = React.createElement(
					"div",
					null,
					"Contact Email:",
					React.createElement("br", null),
					...
					"Paypal Email:",
					React.createElement("br", null),
					React.createElement("input", { type: "text", ref: "paypalEmail" })
				);
			}

			return React.createElement(
				"div",
				{ className: "panel", id: "requestPanel" },
				React.createElement(
					"div",
					null,
					React.createElement(
						"h3",
						null,
						"we see you are doing pretty well..."
					),
					React.createElement(
						"h2",
						null,
						"If you end up winning, how would you like your $10?"
					),
					React.createElement(
						"table",
						null,
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									"td",
									null,
									React.createElement("input", { type: "radio", name: "payMethod", id: "cash", onChange: this.showCash }),
									React.createElement(
										"label",
										{ htmlFor: "cash" },
										"Cash"
									...
									React.createElement("br", null),
									React.createElement("input", { type: "radio", name: "payMethod", id: "paypal", onChange: this.showPaypal }),
									React.createElement(
										"label",
										{ htmlFor: "paypal" },
										"Paypal"
									...
									React.createElement("br", null),
									React.createElement("input", { type: "radio", name: "payMethod", id: "asklater", onChange: this.hideAll }),
									React.createElement(
										"label",
										{ htmlFor: "asklater" },
										"Ask me later"
	...
	var WelcomeMessage = React.createClass({
		...
		render: function render() {
			return React.createElement(
				"div",
				{ className: "panel", id: "welcomeMessage" },
				React.createElement(
					"div",
					null,
					React.createElement(
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						"span",
						{ id: "x", onClick: this.props.toggleWinners },
						"[x]"
					),
					React.createElement(
						"h2",
					...
					React.createElement("img", { src: bob, className: "winpic" }),
					React.createElement("br", null),
					React.createElement(
						"section",
						null,
	...
	var TapFour = React.createClass({
		...
		headerChange: function headerChange(text) {
			this.setState({
				headerText: text
			});
		},

		scoreChange: function scoreChange(score) {
			this.setState({
				score: score
			});
		},

		roundChange: function roundChange(score) {
			this.setState({
				curRound: score
			});
		},

		inGameChange: function inGameChange(bool) {
			this.setState({
				inGame: bool
			});
		},

		continueOnNewUser: function continueOnNewUser() {
		...
		blockEmitOnContinue: function blockEmitOnContinue() {
			this.setState({
		...
		closeRequestPanel: function closeRequestPanel() {
			this.setState({
				displayRequest: false,
				displayWelcome: false
			});
		...
		render: function render() {
			...
			if (this.state.displayWelcome) {
				optionalWelcome = React.createElement(WelcomeMessage, { continueOnNewUser: this.continueOnNewUser });
			}
			var optionalRequest;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "2407bb0262690da745f2d9f8b7c277ea.png"

/***/ },
/* 166 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "1b89e24c30637b30816504d64dd98d24.png"

/***/ },
/* 167 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "f3954096a33f82a199d8aa5240bcfd8b.png"

/***/ },
/* 168 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "e2c7071f9bd66bcbc30178bf638d042d.png"

/***/ },
/* 169 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "ae237d0c79afd9650ab6ce0eb665d589.png"

/***/ },
/* 170 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "5140a3d935e505d6252d0c917b559356.png"

/***/ },
/* 171 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "5c6bd477e4abdb0b65904239608b4ebf.png"

/***/ },
/* 172 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "ac1839b05d92a3c9818f9063ad10098e.png"
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./odometer-theme-minimal.css", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./odometer-theme-minimal.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "08394c0461fc96d9364aba5ada714ab6.png"

/***/ },
/* 180 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "116e75b96ca93a7b16b1c1b1ced8df3e.png"

/***/ },
/* 181 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "25fc7ac7430ce4727b2bbb3b1bccc638.png"
